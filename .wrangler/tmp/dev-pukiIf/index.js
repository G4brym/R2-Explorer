...
var OpenAPIRegistryMerger = /* @__PURE__ */ __name(class extends OpenAPIRegistry {
  _definitions = [];
  merge(registry) {
    if (!registry || !registry._definitions)
      return;
...
var OpenAPIHandler = /* @__PURE__ */ __name(class {
  router;
  options;
  registry;
...
var HonoOpenAPIHandler = /* @__PURE__ */ __name(class extends OpenAPIHandler {
  getRequest(args) {
...
__name(PutMetadata, "PutMetadata");
...
var ClassifyDocument = class extends OpenAPIRoute {
  ...
  async handle(c) {
    ...
    try {
      console.log("\u{1F9E0} Worker: Starting Claude API call for:", data.filename);
...
- other: Everything else`
      ...
      console.log("\u{1F4E5} Worker: Claude API response status:", response.status);
      if (!response.ok) {
        throw new Error(`Claude API error: ${response.status} - ${JSON.stringify(result)}`);
      }
      const aiResponse = result.content?.[0]?.text || "{}";
      console.log("\u{1F916} Worker: Claude response text:", aiResponse);
      ...
      console.error("\u{1F6A8} Worker: Claude API call failed:", error);
      return {
        success: false,
...
__name(ClassifyDocument, "ClassifyDocument");
...
// node_modules/.pnpm/wrangler@3.99.0_@cloudflare+workers-types@4.20241202.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// node_modules/.pnpm/wrangler@3.99.0_@cloudflare+workers-types@4.20241202.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-6yihzb/middleware-insertion-facade.js
...
// node_modules/.pnpm/wrangler@3.99.0_@cloudflare+workers-types@4.20241202.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-6yihzb/middleware-loader.entry.ts
