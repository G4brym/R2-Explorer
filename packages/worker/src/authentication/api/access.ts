...
import type { Context, R2ExplorerConfig } from "../../interfaces";
				...
				errors: [
					{
						code: 10000,
						message:
							"Authentication error! Verify that the Cloudflare Access Team name is correct",
					},
				],
			},
			{ status: 401 },
...
async function getPublicKeys(
	...
	const jwtUrl = `${getAccessHost(config.cfAccessTeamName)}/cdn-cgi/access/certs`;
