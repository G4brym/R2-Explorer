...
import { CollapsibleRoot as Collapsible, CollapsibleContent, CollapsibleTrigger } from 'radix-vue'
import {
  XIcon,
  FolderIcon,
  SearchIcon,
...
const availableFolders = ref<Array<{ name: string; path: string; depth: number }>>([])
...
const canMove = computed(() => {
  ...
  const destinationPath = selectedFolder.value ? `${selectedFolder.value}/` : ''
